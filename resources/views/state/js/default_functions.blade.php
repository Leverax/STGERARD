<script>
    function getState(){
        ...
        var route = '{{route("etat.search" , ":year_id")}}'
    ...
    function exportExcel(){
        ...
        if (start_date && end_date) {
            ...
            var route_export = "{{ route('export.excel' , [':start_date' , ':end_date']) }}"
    ...
    function exportExcelByYearAndClass(){
        ...
        if (academic_year_sort && classroom_sort) {
            ...
            var route_export = "{{ route('export.sort_excel' , [':academic_year' , ':classroom']) }}"
