...
@section('title-page') Tableau de bord @endsection
...
@section('content-page')
    ...
    <div class="row py-3">
        <div class="col-12 text-center">
            <h3> {{ $academic_year_active ? "Récapitulatif / ".$academic_year_active->name : "Aucune année académique active" }}</h3>
        </div>
    </div>
    <!-- Line Chart Card -->
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder">{{ $n_register }}</h2>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder"> {{ $n_sold }}</h2>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder">{{ $n_unsold }}</h2>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder">{{ $backward->count() }}</h2>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder text-danger" style="color:rgb(198, 0, 0) !important;">{{ $backward->sum('backward').' F CFA' }}</h2>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder">{{ \App\Helpers\FormatNumberToLetter::formatNumber($amount[0]) }} F CFA</h2>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder text-success" style="color: rgb(8, 216, 8) !important;">{{ \App\Helpers\FormatNumberToLetter::formatNumber($amount[1]) }} F CFA</h2>
