<script>
    ...
    function editSchooling(id){
        var route_edit = '<?php echo e(route("schooling_details.edit" , ":id")); ?>'
    ...
    function updateSchooling(id) {
        ...
        var route = '<?php echo e(route("schooling_details.update" , ":id")); ?>'
...
</script><?php /**PATH C:\server_xampp\htdocs\csiledesroses\resources\views/schooling/js/edit.blade.php ENDPATH**/ ?>