...
<div class="modal fade" id="create-modal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <form id="create-form" class="add-new-record modal-content pt-0" method="POST" action="<?php echo e(route('expense.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-body flex-grow-1">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <select class="select2 form-control" name="cycle" id="cycle">
                    ...
                    <div class="form-group col-lg-6">
                        <label class="form-label" for="receiver">Bénéficiaire</label>
                        <div class="input-group input-group-merge">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i data-feather="edit"></i></span>
                            </div>
                            <input type="text" name="receiver" id="receiver" class="form-control dt-full-name" placeholder="Entrer le bénéficiaire ici" aria-label="Nom Prénom"/>
                        </div>
                    </div>
...
</div><?php /**PATH C:\xampp\htdocs\csiledesroses\resources\views/expense/modal/create.blade.php ENDPATH**/ ?>