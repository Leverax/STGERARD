    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder text-danger" style="color:rgb(229, 11, 11) !important;" id="expense"><?php echo e(\App\Helpers\FormatNumberToLetter::formatNumber($expense)); ?> F CFA</h2>
                        <p class="card-text text-danger" style="color:rgb(229, 11, 11) !important;">Dépenses</p>
                    </div>
                    <div class="avatar bg-light-danger p-50" style="color:rgb(229, 11, 11) !important;">
                        <div class="avatar-content">
                            <i data-feather='corner-down-left' class="font-medium-5"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder" id="recipe"><?php echo e(\App\Helpers\FormatNumberToLetter::formatNumber($recipe)); ?> F CFA</h2>
                        <p class="card-text">Autres Recettes</p>
                    </div>
                    <div class="avatar bg-light-info p-50">
                        <div class="avatar-content">
                            <i data-feather='corner-up-right' class="font-medium-5"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder text-success" style="color: rgb(13, 174, 13) !important;" id="gain"><?php echo e(\App\Helpers\FormatNumberToLetter::formatNumber($amount[1] + $recipe - $expense)); ?> F CFA</h2>
                        <p class="card-text text-success" style="color: rgb(13, 174, 13) !important;">Montant dans la caisse</p>
                    </div>
                    <div class="avatar bg-light-success p-50" style="color: rgb(13, 174, 13) !important;">
                        <div class="avatar-content">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\server_xampp\htdocs\csiledesroses\resources\views/dashboard/index.blade.php ENDPATH**/ ?>