      ...
      function dataTable(name, export_column, add_btn={label:null,modal_id:null}, orderGroup=false , tag_id="#table", responsive=true, autoWith=true, paging=true, searching=true, info=true ){
            if (!orderGroup) {
                $(tag_id).DataTable({
                    ...
                    "info":     info,
                    "language" : {
                        "url" : '<?php echo asset('/plugins/dataTable.french.lang'); ?>'
                    },
                    dom:
...
</script><?php /**PATH C:\server_xampp\htdocs\csiledesroses\resources\views/layouts/js/functions.blade.php ENDPATH**/ ?>