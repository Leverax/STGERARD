    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder" style="color:rgb(229, 11, 11) !important;" id="expense"><?php echo e(\App\Helpers\FormatNumberToLetter::formatNumber($expense)); ?> F CFA</h2>
                        <p class="card-text">Dépenses</p>
                    </div>
                    <div class="avatar bg-light-primary p-50" style="color:rgb(229, 11, 11) !important;">
                        <div class="avatar-content" style="color:rgb(229, 11, 11) !important;">
        ...
        <div class="col-lg-4 col-sm-6 col-12">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h2 class="font-weight-bolder" style="color: rgb(13, 174, 13) !important;" id="gain"><?php echo e(\App\Helpers\FormatNumberToLetter::formatNumber($amount[1] + $recipe - $expense)); ?> F CFA</h2>
                        <p class="card-text" style="color: rgb(13, 174, 13) !important;">Montant dans la caisse</p>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\server_xampp\htdocs\csiledesroses\resources\views/state/index.blade.php ENDPATH**/ ?>