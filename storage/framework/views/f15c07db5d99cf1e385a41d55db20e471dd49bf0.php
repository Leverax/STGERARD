    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
          ...
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li class=" nav-item">
                <a class="d-flex align-items-center" href="app-email.html">
                  <i data-feather='plus-square'></i><span class="menu-title text-truncate" data-i18n="Email">Autres</span>
                </a>
                <ul class="menu-content">
                  <li class="<?php echo e(Route::currentRouteName() == 'recipe.index' ? 'active' : ''); ?>">
                    
                    <a class="d-flex align-items-center" href="<?php echo e(route('recipe.index')); ?>">
                      <i data-feather='corner-up-right' class="sub-menu-item"></i><span class="menu-item text-truncate" data-i18n="List">Recettes</span>
                    </a>
                  </li>
                  <li class="<?php echo e(Route::currentRouteName() == 'expense.index' ? 'active' : ''); ?>">
                    <a class="d-flex align-items-center" href="<?php echo e(route('expense.index')); ?>">
                      <i data-feather='corner-down-left' class="sub-menu-item"></i><span class="menu-item text-truncate" data-i18n="List">Dépense</span>
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <!-- END: Main Menu--><?php /**PATH C:\server_xampp\htdocs\csiledesroses\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>